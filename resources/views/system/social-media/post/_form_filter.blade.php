{!! Form::open(['route' => 'system.social-media.post.index', 'method' => 'get', 'autocomplete' => 'off']) !!}
<div class="row">
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="form-group">
            {!! Form::select('client_id', $clients, isPost(Request::get('client_id')) ? Request::get('client_id') : null, ['data-plugin' => 'select2', 'class'=>'form-control mb-md', 'data-placeholder' => 'Cliente']) !!}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
    ...
    <div class="col-md-12 text-right  mb-md-3">
        <a href="{{ route('system.social-media.post.index') }}" title="Limpar" class="btn btn-danger mb-md"><i class="fa fa-trash"></i> Limpar</a>
