{!! Form::open(['route' => 'system.social-media.post.all', 'method' => 'get', 'autocomplete' => 'off']) !!}
<div class="row">
    <div class="col-md-3">
    ...
    <div class="col-md-12 text-right  mb-md-3">
        <a href="{{ route('system.social-media.post.all') }}" title="Limpar" class="btn btn-danger mb-md"><i class="fa fa-trash"></i> Limpar</a>
