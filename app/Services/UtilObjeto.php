...
class UtilObjeto
{
    ...
    public function video($url, $class = "", $width = "", $height = "", $size = "large", $autoPlay = "")
    {
        if ($size == "thumb") {
            $size = 1;
        } else {
        ...
        if (isset($image_url['host']) && !empty($image_url['host'])) {
            if ($image_url['host'] == 'www.youtube.com' || $image_url['host'] == 'youtube.com') {
                ...
                return '<iframe class="' . $class . '" width="'.$width.'" height="' . $height . '" src="https://www.youtube.com/embed/' . substr($array[0], 2) . $relAutoPlay . '" frameborder="0" allowfullscreen></iframe>';
