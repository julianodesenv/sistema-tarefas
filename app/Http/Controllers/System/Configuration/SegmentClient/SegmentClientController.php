...
namespace AgenciaS3\Http\Controllers\System\Configuration\SegmentClient;
...
class SegmentClientController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('system.configuration.segment-client.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Segmentos de Cliente";
        $config['activeMenu'] = 'configuration';
        $config['titleMenu'] = 'Configurações';
        $config['activeMenuN2'] = 'user';
        $config['titleMenuN2'] = 'Segmentos de Cliente';
    ...
    public function create()
    {
        ...
        return view('system.configuration.segment-client.create', compact('config'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('system.configuration.segment-client.edit', compact('dados', 'config'));
    }
